...
export const Footer = () => {
  return <footer className="mx-auto h-full bg-black opacity-75"><h3 className="text-white justify-center flex">FOLLOW US</h3>
        ...
        <div className="text-white flex flex-wrap justify-center relative">
