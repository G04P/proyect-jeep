  ...
  return (
    <section >
        <div className='flex justify-center p-6 flex-col'>
         ...
         <Link className='border font-bold p-4 bg-yellow-400 rounded-full text-center container mx-auto w-80 hover:bg-transparent hover:border-yellow-400' to={"/Service/Mantenimiento"}> <button>SOLICITAR TURNO</button></Link>  
        </div>
    </section>
  )
}
